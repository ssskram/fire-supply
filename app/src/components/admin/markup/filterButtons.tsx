    ...
    return (
      <div className="text-center row">
        <div className="col-sm-4">
          <button
            onClick={() => this.props.setFilter("all orders")}
            style={
              this.props.filter == "all orders"
                ? style.buttonClicked
                : undefined
            }
            className="btn btn-filter grey"
          >
            All Orders
        ...
        <div className="col-sm-4">
          <button
            onClick={() => this.props.setFilter("emergency orders")}
            style={
              this.props.filter == "emergency orders"
                ? style.buttonClicked
                : undefined
            }
            className="btn btn-filter red"
          >
            Emergency Orders
        ...
        <div className="col-sm-4">
          <button
            onClick={() => this.props.setFilter("open orders")}
            style={
              this.props.filter == "open orders"
                ? style.buttonClicked
                : undefined
            }
            className="btn btn-filter orange"
          >
            Open Orders

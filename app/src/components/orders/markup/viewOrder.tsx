          ...
          <div className="text-center">
            ...
            <div
              style={{
                borderColor: "#383838",
                marginBottom: "5px",
                backgroundColor: getColorByStatus(order.status)
              }}
              className="alert"
            >
              <div>
            ...
            {order.receivedBy && (
              ...
              >
                <div>
                  Received by: <b>{order.receivedBy}</b>
                </div>
              </div>
            )}
          ...
          <div>
            ...
            <div>
              <span className="pull-left">
                {order._id && (
                  <div>Order #{order._id.substr(order._id.length - 6)}</div>
                )}
              </span>
            ...
            {doesOrderContainNarcan(order.supplies) &&
              this.props.order.department == "Bureau of Fire" && (
                <div style={narcanContainer} className="text-center">
                  <b>NARCAN</b>
                  <div>
                    <b>In posession of cases:</b> {order.narcanCases.toString()}
                  </div>
